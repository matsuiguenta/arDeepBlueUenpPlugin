...
class arDeepBlueUenpPluginConfiguration extends sfPluginConfiguration
{
  public static
    $summary = 'Custom theme plugin, extension of arDominionPlugin.<br> Author: Rogério Matsui Guenta',
    $version = '0.0.1';
  ...
  public function contextLoadFactories(sfEvent $event)
  {
    ...
    if ($context->getConfiguration()->isDebug())
    {
      ...
      $context->response->addStylesheet('/plugins/arDeepBlueUenpPlugin/css/main.less', 'last', array('rel' => 'stylesheet/less', 'type' => 'text/css', 'media' => 'all'));
    }
    else
    {
      $context->response->addStylesheet('/plugins/arDeepBlueUenpPlugin/css/min.css', 'last', array('media' => 'all'));
    }
  }
